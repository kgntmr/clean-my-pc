...
:notextracted
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "Add-Type -AssemblyName PresentationFramework; [void][System.Windows.MessageBox]::Show('Clean My PC needs to be unzipped before it can start.' + [char]10 + [char]10 + '1. Close this message.' + [char]10 + '2. Right-click CleanMyPC.zip and choose Extract All, then Extract.' + [char]10 + '3. In the new folder, double-click Start Clean My PC.', 'Clean My PC')"
exit /b
